...
var gLanguage = "English"; // Current language selection (for quick switching between languages)
var basicLanguage = "English"; // Basic (ticked) Language selection
var gChars=new Array(256); 
...
function gIncJamoCounter(){
	...
	if (gJamoCounter == 3){ // Passing middle of syllable?
		switch (gRef) { // In case of another vowel, you should not have incremented
	...
	if (gJamoCounter == 3){gJamoCounter = 0;}
...
// Code point of Hangul = (uTail-4519) + (uVowel−4449)*28 + (uLead−4352)*588 + 44032 
// a.substring(2,5)
...
if (gLanguage == "Icelandic"){
gChars[39]="\u0308 "; // combining diaeresis U+0308 ( ̈  ) - lower right, tab group
//gChars[40]="å"; //§ lower left ctrl group
gChars[40]="ð";
gChars[41]="\u0301"; // combining acute accent U+0301 - upper right, tab group
}

if (gLanguage == "Finnish"){
gChars[39]="\u0308"; // combining diaeresis U+0308 ( ̈  ) - lower right, tab group
gChars[40]="§"; //§ lower left ctrl group
gChars[41]="\u030c"; // combining caron U+030C ( ̌  )- upper right, tab group
}
...
gChars[41]="\u0302"; // combining circumflex U+0302 (̂  )- upper right, tab group
